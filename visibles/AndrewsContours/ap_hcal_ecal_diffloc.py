# used when visualizing an hcal and an ecal deposition 
import numpy as np
import sys
import array
tmpargv = sys.argv
...
for i in range(0, nMass):
        ...
        for j in range(0, NepsBins):
                ...
                nsig = N_sig(Naprime, zmin1, zmax1, gctau)
                ...
                nsig2 = N_sig(Naprime2, zmin2, zmax2, gctau2)
                NAprime2.Fill(mass, eps, Naprime2)
                GamCTau2.Fill(mass, eps, gctau2)
                detectable2.Fill(mass, eps, nsig2)


with open(outfile+'_1e14eot_4gev.csv', 'w') as f1: # print csv
...
legend.AddEntry(detectable, "Ecal")
legend.AddEntry(detectable2, "Hcal")
legend.Draw()
c.Print(outfile+".pdf")
closePDF(outfile,c)
